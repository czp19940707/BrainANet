...
class NestedGraphSAGE(torch.nn.Module):
    def __init__(self, input_dim, hidden, use_z=False, use_rd=False, hidden_linear=64, num_layers=2, num_classes=2):
...
class GraphSAGE(torch.nn.Module):
    def __init__(self, input_dim, hidden, num_layers=2, num_classes=2, *args, **kwargs):
